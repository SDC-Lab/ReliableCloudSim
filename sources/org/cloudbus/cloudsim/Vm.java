...
public class Vm {
	...
	//private double previousTime; //Declared by Yogesh Sharma 
	
	//private double utilization; //Declared by Yogesh Sharma 
	 ...
	 * @post $none
	 */
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) { // Changed by Yogesh Sharma 
	 ...
	 */
	//public void setPreviousTime(final double previousTime) { //Defined by Yogesh Sharma
	...
	//double currentUtilization; // Written by Yogesh Sharma 
	
	//public void setCurrentUtilization(double currentUtilization){ // Written by Yogesh Sharma 
	//	this.currentUtilization = currentUtilization;
	//}
	//public double getCurrentUtilization(){ // Written by Yogesh Sharma 
	 ...
	 */
	public void setMips(double mips) { //Original access specifier for this function is protected
		this.mips = mips;
	}
