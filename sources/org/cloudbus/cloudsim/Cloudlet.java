...
public class Cloudlet {
	...
	/**
	 * Normalize the cloudlet length to calculate the utilization by each cloudlet
	 */
	
	//public ArrayList<Double> normCloudletLength = new ArrayList<Double>();
	
	//public boolean setnormCloudletLength(long cloudletLength, long max){
	...
	/*
	public void setInitialSubmissionTime(final double cloudTime){
		if(cloudTime < 0.0 || index <0 ){
			return;
		}
	}
	*/
