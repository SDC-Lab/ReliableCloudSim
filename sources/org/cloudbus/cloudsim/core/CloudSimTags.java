...
public class CloudSimTags {
	...
	/** 
	 * Denotes the failure event
	 */
	public static final int FAILURE_OCCURRENCE_EVENT = BASE + 500;
	
	/** 
	 * Denotes the failure event
	 */
	public static final int FAILURE_RECOVERY_EVENT = BASE + 501;
	
	/** Recovers a failed cloudlet. */
	public static final int CLOUDLET_RECOVER = BASE + 502;
	
	public static final int FAILURE_OCCURRENCE_EVENT_WITH_PERFECT_CHECKPOINTING = BASE + 503;
	
	public static final int FAILURE_RECOVERY_EVENT_WITH_PERFECT_CHECKPOINTING = BASE + 504;
	
	public static final int CREATE_CHECKPOINT = BASE + 505;
	
	public static final int FAILURE_OCCURRENCE_EVENT_WITH_CHECKPOINTING = BASE + 506;
	
	public static final int FAILURE_RECOVERY_EVENT_WITH_CHECKPOINTING = BASE + 507;
	
	public static final int SAVE_VM_UTILIZATION = BASE + 508;
	
	public static final int VM_MIGRATION = BASE + 509;
	
	public static final int FAILURE_OCCURRENCE_EVENT_WITH_MIGRATION_CHECKPOINTING = BASE + 510;
	
	public static final int FAILURE_RECOVERY_EVENT_WITH_MIGRATION_CHECKPOINTING = BASE + 511;
	
	public static final int VM_MIGRATION_CHECKPOINTING = BASE + 512;
	
	public static final int CREATE_CHECKPOINT_WITH_MIGRATION = BASE + 513;
	
	public static final int VM_CONSOLIDATION = BASE + 514;
	
	public static final int VM_CONSOLIDATION_CHECKPOINTING = BASE + 515;
	
	public static final int CREATE_VM_REPLICATION = BASE + 516;
