...
public class K_MeansAlgorithmLANL {
	public FTAFileReader ftaread;	
	public FTAFileReader ftaread_LANL;
	public double clusterName;	
	...
	public HashMap<Double, HashMap<Integer, ArrayList<Integer>>>locationWiseClustering = new HashMap<Double, HashMap<Integer, ArrayList<Integer>>>();
	
	public void setFTARead(FTAFileReader ftaread){
		this.ftaread = ftaread;
	}	
	
	public void initializeKMeansAlgorithm(Double clusterName){
