...
import org.cloudbus.cloudsim.failure.HostUtilizationHistory;
...
public class Datacenter extends SimEntity {
	...
	//protected void processVmCreate(Vm vm){ 	//This function is written by Yogesh Sharma for the implementation of rate of arrival of cloudlets. 
	//}
	...
	protected void processCloudletSubmit(SimEvent ev, boolean ack) {
		...
		try {
			...
			//System.out.println("Values are" +vmId+ " " +cletId);
			//System.out.println("Values are" +vmId);
	...
	/**
	 * Verifies if some cloudlet inside this Datacenter already finished. If yes, send it to
	 * the User/Broker
	 * 
	 * @pre $none
	 * @post $none
