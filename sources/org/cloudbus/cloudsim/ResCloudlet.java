...
import org.cloudbus.cloudsim.failure.CloudletEventCounter;
...
public class ResCloudlet {
	...
	//	}
		...
		setremaininglength((long)Math.floor(length / Consts.MILLION)); // Written by Yogesh Sharma		
		CloudletStatus.setremainingCloudlet(cloudlet.getCloudletId(), (long)Math.floor(length / Consts.MILLION)); //Written by Yogesh Sharma		
		CloudletStatus.setsofarCloudlet(cloudlet.getCloudletId(), (cloudletFinishedSoFar/ Consts.MILLION)); //Written by Yogesh Sharma			
		return (long) Math.floor(length / Consts.MILLION);		
	}
	
	/**
	 * These four static functions are written by Yogesh Sharma
	 */
	
	static long remaininglength;
	
	static long sofarlength;	
	
	public static void setsofarlength(long length){
		sofarlength = length;
	}
	...
	public void setremaininglength(long length){			
		
		remaininglength = length;
	}
	
	public static long getremaininglength(){
	...
	public static ArrayList<Double> timeHistory = new ArrayList<Double>();
	boolean check_clock = false;
	public static ArrayList<Vm> vmHistory = new ArrayList<Vm>();
	boolean check_vm = false;
	...
	public void updateCloudletFinishedSoFar(long miLength) {	
		cloudletFinishedSoFar += miLength; // Statement except this are written by Yogesh Sharma 		
	}
