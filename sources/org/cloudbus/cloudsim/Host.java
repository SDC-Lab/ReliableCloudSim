...
public class Host {
	...
	public Host(
			int id,
			//double utilization, // Written by Yogesh Sharma 
		...
		//setUtilization(utilization); // Written by Yogesh Sharma 
		setPeList(peList);
		setFailed(false);
	}

	/*
	public void setUtilization(double utilization){		// Written by Yogesh Sharma 
		this.utilization = utilization;
		
	}
	
	public double getUtilization(){ // Written by Yogesh Sharma 
		return utilization;
	}
	
	public void calUtilization(){ // Written by Yogesh Sharma 
		Vm vm;
		//double utilization;
		...
		setUtilization(totalUtilization);		
	}
	*/
	/**
